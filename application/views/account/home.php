              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="<?= base_url();?>assets/dist/img/profile/<?= $profil['foto'];?>"
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          <h3 class="timeline-header border-0"><?= $log->log;?>
                          </h3>
                        </div>
                      </div>
                      <!-- END timeline item -->
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="<?= base_url('profile'); ?>" method="post" enctype="multipart/form-data">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="tect" class="form-control" id="inputEmail" placeholder="NRG" value="<?= $profil['nrg'];?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="telp" class="form-control" id="inputName2" placeholder="Telp" value="<?= $profil['telp'];?>">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" name="repassword" class="form-control" id="inputName2" placeholder="Re-Password">
                        </div>
                      </div>
                      <div class="form-group row"> 
