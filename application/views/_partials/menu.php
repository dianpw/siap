  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php if ($this->session->userdata('role') == '5ef49b3c63cff') { //Administrator ?>          
            <li class="nav-item">
    ...
    <?php }elseif ($this->session->userdata('role') == '5ef49b44b491f') { //Owner ?>
          
    <?php }elseif ($this->session->userdata('role') == '5ef49b4c1eb6b') { //Accounting ?>
          
    <?php }elseif ($this->session->userdata('role') == '5ef49b5314fc9') { //Admin ?>
          
    <?php }elseif ($this->session->userdata('role') == '5ef49bfeabf92') { //User ?>            
    <?php } ?>
          <li class="nav-item">
